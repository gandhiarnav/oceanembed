"""
OceanEmbed — Download GLORYS12V1 Surface Input Variables (SST, SSH, U/V Currents)
...
def download_glorys_surface(
    start_date: str = "2020-01-01T00:00:00",
    end_date: str = "2020-01-31T23:59:59",
    output_filename: str = "glorys_surface_inputs_jan2020.nc",
    ...
    print(f"  Depth     : 0.0 – 0.5 m (surface layer only)")
...
def main():
    parser = argparse.ArgumentParser(description="Download GLORYS surface variables.")
    ...
    parser.add_argument("--output", type=str, default="glorys_surface_inputs_jan2020.nc", help="Output filename")

    args = parser.parse_args()
    download_glorys_surface(start_date=args.start, end_date=args.end, output_filename=args.output)
